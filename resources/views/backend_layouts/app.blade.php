    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="/assets/logo_sewing_title.png" style="background-color: antiquewhite" alt="Logo"
                    class="brand-image img-circle elevation-3">
                <span class="brand-text text-bold">Jait <strong class="text-warning">Oya</strong></span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/dashboard" class="nav-link">
                                <i class="nav-icon fa fa-fw fa-sign-out-alt opacity-25"></i>
                                <p>
                                    Logout
                                </p>
                            </a>
